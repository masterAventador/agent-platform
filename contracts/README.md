...
- `capabilities/social-operations/local-executor-v1.schema.json`：Social Operations 本地执行器 v1，包含任务、步骤进度、人工接管和脱敏诊断消息；
- `capabilities/social-operations/local-executor-v1.md`：本地执行器幂等、取消、控制事件顺序、兼容和安全语义；
- `fixtures/capabilities/social-operations/local-executor-v1/`：10 个有效、25 个无效协议回放样例。
