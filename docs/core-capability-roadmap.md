...
| C03 MVP Profile 基础设施验收 | 隔离随机端口真实启动 PostgreSQL、Redis、MinIO、LiteLLM Stub、API、Dispatcher、Worker、Sandbox Controller/Janitor 和 Web；生产 `LiteLLMChatModelFactory → LiteLLM → Stub` 调用、重复启动、故障健康检查、恢复、重复停止及容器/网络/卷清理通过；RAGFlow 未启动 |
