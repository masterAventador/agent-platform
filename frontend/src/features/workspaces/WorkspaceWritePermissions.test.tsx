...
vi.mock('../tools/api/queries', () => ({
  ...
  useToolInvocations: vi.fn(() => ({ data: [], isPending: false })),
  useToolVersions: vi.fn(() => ({ data: [], isPending: false })),
  useSyncReports: vi.fn(() => ({ data: [], isPending: false })),
  ...
  useUpdateMcpServer: vi.fn(() => ({ isPending: false, isError: false, reset: vi.fn() })),
  useDeleteMcpServer: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
  useUpdateTool: vi.fn(() => ({ isPending: false, isError: false, reset: vi.fn() })),
  useDeleteTool: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
  useRollbackTool: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
  useTestMcpServerConnection: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
  useSyncMcpServer: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
  useConfigureMcpServerCredentials: vi.fn(() => (
    { isPending: false, isError: false, reset: vi.fn(), mutateAsync: vi.fn() }
  )),
  useRemoveMcpServerCredentials: vi.fn(() => ({ isPending: false, mutateAsync: vi.fn() })),
